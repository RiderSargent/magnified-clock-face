...
var author$project$Main$viewHand = F3(
	function (width, length, turns) {
		...
		var xOne = 200 - (length * elm$core$Basics$cos(t));
		var y = 200 + (length * elm$core$Basics$sin(t));
		var yOne = 200 - (length * elm$core$Basics$sin(t));
		return A2(
			elm$svg$Svg$line,
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$x1(
					elm$core$String$fromFloat(xOne)),
					elm$svg$Svg$Attributes$y1(
					elm$core$String$fromFloat(yOne)),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$svg$Svg$Attributes$style('background-color: #ddd;')
			]),
		_List_fromArray(
			[
